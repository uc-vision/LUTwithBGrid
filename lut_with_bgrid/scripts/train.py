#!/usr/bin/env python3
"""
Training script for LUT with Bilateral Grid image enhancement.
Usage: python scripts/train.py --dataset_name fivek --input_color_space sRGB
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Training script for LUT with Bilateral Grid")
    ...
    parser.add_argument("--output_dir", type=str, default="Bilateral_LUTs",
                       help="path to save model")
    parser.add_argument("--backbone_coef", type=int, default=8,
                       help="backbone coefficient")
    ...
    parser.add_argument("--lut_n_ranks", type=int, default=8,
                       help="number of LUT generator ranks")
    parser.add_argument("--lut_interpolation", type=str, default="tetra",
                       help="method of LUT grid interpolation")
    ...
    parser.add_argument("--grid_interpolation", type=str, default="tri",
                       help="method of GRID grid interpolation")
    ...
    lut_bgrid_inst = LUTwithBGrid(
        ...
        backbone_coef=opt.backbone_coef,
        lut_n_vertices=opt.lut_n_vertices,
        lut_n_ranks=opt.lut_n_ranks,
